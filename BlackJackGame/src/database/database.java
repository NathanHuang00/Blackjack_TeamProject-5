...
public class database
{
	...
	public database()
	{
		...
		try
		{
			fis = new FileInputStream("files/db.properties");
			prop.load(fis);
	...
	{
		String query = "select username, balance from user";
		ArrayList<String> data = this.query(query);
		for (String str : data)
		{
			String[] split = str.split(",");
	...
	public void addData(String data)
	{
		...
		String stmt = "insert into user values('" + dataArray[0] + "', " + dataArray[1] + ",100)";
